...
class _$ProductStateImpl implements _ProductState {
  ...
  @override
  String toString() {
    return 'ProductState(status: $status, products: $products, errorMessage: $errorMessage, lastAddedItemResponse: $lastAddedItemResponse)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
              other._lastAddedItemResponse,
              _lastAddedItemResponse,
            ));
  }
