...
class OtpSendPage extends StatefulWidget {
  final String phone; // sessionId o'rniga phone

  const OtpSendPage({super.key, required this.phone});
...
class _OtpSendPageState extends State<OtpSendPage> {
  ...
  void _resendCode() {
    ...
    // Qayta yuborishda telefon raqam ishlatiladi
    context.read<AuthCubit>().sendPhone(widget.phone);
    pinController.clear();
    _startTimer();
    showTopSnackBar(
      Overlay.of(context),
  ...
  void _verifyCode(BuildContext context) {
    ...
    context.read<AuthCubit>().verifyCode(widget.phone, pinController.text);
  }
